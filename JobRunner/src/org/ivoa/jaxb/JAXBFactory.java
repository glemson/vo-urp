...
public final class JAXBFactory extends SingletonSupport {
   ...
   */
  private JAXBContext getContext(final String path) throws JAXBException  {
    JAXBContext c = null;
   ...
   * @throws XmlBindException if a JAXBException was caught
   */
  public String toString(final Object o, final int bufferCapacity) throws JAXBException {
    if (o != null) {
      // create an Unmarshaller
   ...
   * @param bufferCapacity memory buffer capacity
   */
  public void dump(final Object o, final int bufferCapacity) throws JAXBException{
    if (log.isDebugEnabled()) {
