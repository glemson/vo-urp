...
/**
 * Deprecated in Version 1.1<p>Java class for Definitions complex type.</p>
 *  <p>The following schema fragment specifies the expected content contained within this class.<pre>
 * &lt;complexType name="Definitions">  &lt;complexContent>
...
public class Definitions {
   ...
   */
  @XmlElements({@XmlElement(name = "PARAM", type = Param.class)
  ...
  /**
   * Gets the value of the coosysAndPARAMS property.<p>This accessor method returns a reference to the live list,
   ...
   *  <p>For example, to add a new item, do as follows:<pre>   getCOOSYSAndPARAMS().add(newItem);</pre></p>
   *  <p>Objects of the following type(s) are allowed in the list {@link Param }{@link CoordinateSystem }</p>
   *
