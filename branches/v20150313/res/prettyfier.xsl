...
<!-- From http://www.xml.com/lpt/a/1681 -->
<!--
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
  ...
  <xsl:template match="/" mode="pretty">
   ...
   <xsl:template match="*|comment()" mode="pretty">
      ...
      <xsl:call-template name="pretty_indent">
   ...
   <xsl:template name="pretty_indent">
   ...
   <xsl:template match="text()" mode="pretty">
      <xsl:call-template name="pretty_escapeNewlines">
   ...
   <xsl:template name="pretty_escapeNewlines">
      <xsl:param name="text"/>
