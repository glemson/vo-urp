...
public class Test {
  ...
  public static void main(final String[] args) {
    ...
    /**
     * Obj is a typical class that implements JSONString. It also provides some beanie methods that can be used
     * to  construct a JSONObject. It also demonstrates constructing a JSONObject with an array of names.
     */
    ...
    try {
      ...
      System.out.println(
        new JSONStringer().object().key("a").array().array().array().value("b").endArray().endArray().endArray()
                          .endObject().toString());
