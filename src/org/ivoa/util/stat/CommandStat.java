...
public final class CommandStat extends BaseStat {
  ...
  public final static void dumpStatsHeader(final StringBuffer sb) {
    ...
    sb.append("EcartType FAIL (ms)").append("\t");
  }
  ...
  public final void dumpStats(final String name, final StringBuffer sb, final boolean reset, final String endLine) {
    if (getMonitorCall() > 0) {
      ...
      synchronized (this.lock) {
        ...
        sb.append("OK    | sigma time Low (ms) : ").append(format(getMonitorTimeOKAverage()));
        sb.append(" | ").append(format(getMonitorTimeOKSigma()));
        sb.append(endLine);

        sb.append("FAIL  | sigma time Low (ms) : ").append(format(getMonitorTimeFAILAverage()));
  ...
  /**
   * @return monitorTimeOK.getStdDevHigh()
   */
  ...
  /**
   * @return monitorTimeOK.getStdDevLow()
   */
  ...
  /**
   * @return monitorTimeFAIL.getStdDevHigh()
   */
