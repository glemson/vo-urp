...
public abstract class MetadataObject extends MetadataElement {
  ...
  /**
   * Indicates if this object is transient (never persisted)
   * @return true if this object is transient (never persisted)
   */
  ...
  public String getIvoId() {
    String ivoId;
    if (isTransient()) {
      ivoId = LocalStringBuilder.concat(IVOIdPrefix, getUtype(), "/", "M", Long.toString(-getId().longValue()));
    } else {
      ivoId = LocalStringBuilder.concat(IVOIdPrefix, getUtype(), "/", Long.toString(getId().longValue()));
    }
    return ivoId;
  }
  ...
  public String getXmlId() {
    String ivoId;
    if (isTransient()) {
      ivoId = LocalStringBuilder.concat(this.getClass().getSimpleName(), "_", "M", Long.toString(-getId().longValue()));
    } else {
      ivoId = LocalStringBuilder.concat(this.getClass().getSimpleName(), "_", Long.toString(getId().longValue()));
    }
    return ivoId;
  }
