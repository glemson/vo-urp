...
public class Identity implements Serializable {
   ...
   * JPA events Transient because the metadata object holds on to the "real" id.
   * 
   * TODO should this be mapped to XML at all? Or only the ivoID?
   */
  @Transient
  @XmlTransient
...
//  @Column(name = "xmlId", nullable = true)
   ...
   * This is not mapped to JPA, as it is generated based on the UTYPE of the object and its generated ID
   */
//@Basic(optional = true)
//@Column(name = "ivoId", nullable = true)
  ...
  /** resolve an incoming IVO Id for a given type to the JPA id of the corresponding object instance 
   * The implied definition of the ivoId (utype+"/"+id), should be synchronised with the getIvoId() method
   * */
  public static Long resolveIvoId(String ivoId, Class type)
  {
