...
public abstract class MetadataObject extends MetadataElement {
    ...
    /** 
     * Generator for purely transient id-s, e.g. used when serialising to XML
     * an object that has no DB representation (yet).<br/>
     */
    private static Long PURELY_TRANSIENT_ID = -1l;
    ...
    public String getIvoId() {
        ...
        return Configuration.getInstance().getIVOIdPrefix() + getUtype() + "/" 
        + (id < 0?"M"+(-id):id);
    }
    ...
    public String getXmlId() {
        return this.getClass().getSimpleName() + "_" + (id < 0?"M"+(-id):id);
    }
    ...
    private Long newId() {
    	synchronized (PURELY_TRANSIENT_ID) {
        	return PURELY_TRANSIENT_ID--;
		}
