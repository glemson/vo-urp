...
/**
 * PUBLIC:
 * <p>This is a wrapper class for org.apache.commons.logging.Log.  It is used when messages need to be
...
public final class CommonsLoggingSessionLog extends AbstractSessionLog {
  ...
  */
  ...
  protected void addLogger(final String loggerCategory, final String loggerNameSpace) {
    if (FORCE_INTERNAL_DEBUG) { System.out.println("CommonsLoggingSessionLog.addLogger : category : " + loggerCategory + " in name space : " + loggerNameSpace); }
  ...
  public int getLevel(final String category) {
    ...
    if (lw == null) {
    if (FORCE_INTERNAL_DEBUG) { System.out.println("CommonsLoggingSessionLog.getLevel : category : " + category + " : OFF"); }
      return OFF;
    }

    if (FORCE_INTERNAL_DEBUG) { System.out.println("CommonsLoggingSessionLog.getLevel : category : " + category + " : level : " + lw.getLevel()); }
    return lw.getLevel();
  }
  ...
  public void setLevel(final int level, final String category) {
    ...
    if (FORCE_INTERNAL_DEBUG) { System.out.println("CommonsLoggingSessionLog.setLevel : category : " + category + " to level : " + l.getLevel()); }
  ...
  public boolean shouldLog(final int level, final String category) {
    ...
    if (FORCE_INTERNAL_DEBUG) { System.out.println("CommonsLoggingSessionLog.shouldLog : category : " + category + " : " + res);}
    return res;
  }
  ...
  public void log(final SessionLogEntry entry) {
    ...
    if (FORCE_INTERNAL_DEBUG) { System.out.println("CommonsLoggingSessionLog.log : message : "+entry.getMessage());}
  ...
  protected void internalLog(final SessionLogEntry entry, final Level level, final Log log) {
    if (FORCE_INTERNAL_DEBUG) { System.out.println("CommonsLoggingSessionLog.internalLog : "+computeMessage(entry, level));}
  ...
  /**
   * INTERNAL:<p>Computes the log message</p>
   *
   * @param entry SessionLogEntry that holds all the information for a EclipseLink logging event
   * @param level according to eclipselink level
   */
