...
public class TAP0_31Servlet extends BaseServlet implements TAP_v0_31 {
    ...
    private TAPResult handleParamQuery(HttpServletRequest request, boolean isSync) {
        ...
        if ("TAP_SCHEMA.tables".equalsIgnoreCase(from) && select == null && where == null && (TAP_v0_31.FORMAT_VALUE_xml.equalsIgnoreCase(format) || TAP_v0_31.FORMAT_VALUE_votable.equalsIgnoreCase(format))) {
