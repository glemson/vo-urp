...
public final class ManagerServlet extends BaseServlet {
    ...
    /** Action parameter value indicating that an uploaded XML doc should be validated against the XML 
     * schemas for the current model and if valid its references should be checked, whether they exist.
     * If still OK can be inserted into the database after user has been assigned.
     */
    ...
    protected void processRequest(final HttpServletRequest request,
        ...
        if (log.isInfoEnabled()) {
            log.info("ManagerServlet [" + getSessionNo(request) +
